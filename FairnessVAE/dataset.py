...
class WholeDataLoader(Dataset):
    def __init__(self,train):
        ...
        if train==0:
            ...
            self.img_list=os.listdir('./data/CelebA/test/test1000')
    ...
    def __getitem__(self, index1):
        ...
        if self.train==0:
            ...
            img1=Image.open('./data/CelebA/test/test1000/'+self.img_list[index1])
            img2=Image.open('./data/CelebA/test/test1000/'+self.img_list[index2])
